...
class GebruikerDAO {
	...
	public static function create($gebruikersnaam, $wachtwoord, $emailadres, $type, $familienaam, $voornaam, $telefoonnummer, $adres, $postId, $status){
		$sql = "insert into gebruikers (gebruikersnaam, wachtwoord, emailadres, type, familienaam, voornaam, telefoonnummer, adres, postId, status)
